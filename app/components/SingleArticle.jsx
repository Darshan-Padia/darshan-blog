...
const SingleArticle = (props) => {
  return (
    <div className=" dark:bg-gray-900 bg-slate-100 shadow-md rounded-md p-2 m-2" >
        ...
        className=" w-full justify-between flex-col-reverse sm:flex-row md:flex-row lg:flex-row  flex gap-5 mt-2" >
            <div className="flex flex-col gap-3 justify-center" >
                ...
                <div className="smallIntro light:text-gray-700 text-sm" >
        ...
        <div className="flex flex-row flex-wrap gap-2 mt-2  mb-2" >
            ...
            style={
                {
                    maxWidth:'327px',width:'100%'
                }
            } 
             className=" flex items-center relevantImageToArticle w-fit bg-contain ">
                <img 
                ...
                // style={{margin:'none',objectFit:'cover'}}
                />
            </div>
        </div>
